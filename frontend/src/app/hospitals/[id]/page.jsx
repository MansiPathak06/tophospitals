        ...
        <div className="flex-1 min-w-0 w-full">
                ...
                <>
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    {gallery.map((img, i) => (
                      <div
                        key={i}
                        className="rounded-xl overflow-hidden bg-[#e6f4f4] aspect-video"
                      >
                        <img
                          src={img}
                          alt={`Gallery ${i + 1}`}
              ...
              {specialities.length === 0 ? (
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                  {specialities.map((s) => (
                    <div
                      key={s}
                      className="bg-[#e6f4f4] rounded-xl px-4 py-3.5 flex items-center gap-2.5"
                    >
              ...
              {doctors.length === 0 ? (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                  {doctors.map((doc, i) => (
                    <div
                      key={i}
                      className="bg-[#f4fafa] border border-[#e6f4f4] rounded-2xl p-4 flex gap-3.5 items-center"
                    >
                      ...
                      <div>
                        ...
                        <p className="text-[#2ec4a0] text-xs font-semibold">
                          {doc.experience} exp.
                        </p>
                      </div>
                    </div>
          ...
          {activeTab === "map" && (
            <div className="bg-white rounded-2xl p-7 shadow-[0_2px_8px_rgba(15,92,92,0.07)]">
              ...
              <p className="text-gray-500 text-[13px] mb-4 flex items-center gap-1.5">
                📍 {hospital.address}
              </p>
              {hospital.map_embed ? (
          ...
          {activeTab === "reviews" && (
            <div className="bg-white rounded-2xl p-7 shadow-[0_2px_8px_rgba(15,92,92,0.07)]">
              ...
              <div className="flex items-center gap-5 bg-[#e6f4f4] rounded-2xl px-6 py-5 mb-5">
        ...
        <div className="w-full lg:w-[300px] flex-shrink-0 flex flex-col gap-4">
          ...
          <div className="bg-white rounded-2xl p-5 shadow-[0_2px_8px_rgba(15,92,92,0.07)]">
            ...
            {[
              ...
              <div
                key={label}
                className="flex gap-3 items-start py-3 border-b border-gray-100"
              >
            ...
            <div className="flex flex-wrap gap-2">
              {specialities.length === 0 ? (
                ...
                specialities.map((s) => (
                  <span
                    key={s}
                    className="bg-[#e6f4f4] text-[#0F5C5C] text-xs font-semibold px-3 py-1.5 rounded-full"
                  >
                    {s}
                  </span>
                ))
